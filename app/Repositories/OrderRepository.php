...
class OrderRepository
{
    ...
    public static function unionBookingByUserIdAndDate(User $user, $date)
    {
        ...
        $agen_order =  Order::select('id', 'fleet_route_id', 'user_id', 'reserve_at', 'status', 'code_order as code')
            ...
            ->addSelect(DB::raw("(select price from fleet_route_prices where fleet_route_id = orders.fleet_route_id and start_at <= '$date' and end_at >= '$date' order by created_at desc limit 1) as price"))
