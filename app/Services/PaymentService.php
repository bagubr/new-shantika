...
class PaymentService
{
    ...
    public static function sendNotificationAlmostExpiry($invoice)
    {
        ...
        PaymentLastThirtyMinuteReminderJob::dispatch($notification, $invoice->order?->user?->fcm_token, false, $invoice->order)
        ...
        $notification = Notification::build($payload[0], $payload[1], Notification::TYPE1, $invoice->order_id);
        PaymentExpiredReminderJob::dispatch($notification, $invoice->order?->user?->fcm_token, false, $invoice->order)
