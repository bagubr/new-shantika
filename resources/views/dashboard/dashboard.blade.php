...
<section class="content">
    <h5 class="m-0">Selamat Datang Di Halaman {{Auth::user()->restaurant_admin?->restaurant->name}}</h5>
</section>
@else
<section class="content">
    ...
    <div class="card card-success">
        ...
        <div class="card-body">            
            ...
            <div class="row">
                <div class="col">
                    <div class="text-center">
                        {{-- <i class="fas fa-arrow-left change-statistic"
                            data-digit-agent="{{$data['digit-agent']??0}}"></i> --}}
                    ...
                    <div class="chart">
                        <canvas id="ChartAgent"
                            style="min-height: 2500px; height: 100%; max-height: 2500px; max-width: 100%;"></canvas>
                    </div>
                </div>
            </div>
        </div>
