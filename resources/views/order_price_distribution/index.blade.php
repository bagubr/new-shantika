                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <a href="{{route('fleet_route.show',$order_price_distribution->order?->fleet_route_id)}}">
                        ...
                        <td>
                            @if (!$order_price_distribution->deposited_at)
                            <form action="{{route('order_price_distribution.update', $order_price_distribution->id)}}"
                                class="d-inline" method="POST">
                                @csrf
                                @method('PUT')
                                <button class="btn btn-primary btn-xs"
                                    onclick="return confirm('Apakah Anda Yakin Ingin Deposit?')" type="submit">Deposit
                                    Sekarang</button>
                            </form>
                            @endif
                            <form action="{{route('order_price_distribution.destroy',$order_price_distribution->id)}}"
                                class="d-inline" method="POST">
                                @csrf
                                @method('DELETE')
