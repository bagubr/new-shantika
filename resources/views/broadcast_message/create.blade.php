        ...
        <div class="col-md-12">
            <div class="card card-primary">
                ...
                <div class="card-body" style="display: block;">
                    ...
                    <form action="{{route('broadcast_message.store')}}" method="POST">
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="message" class="form-control" placeholder="Masukkan Pesan" required>
                        </div>
